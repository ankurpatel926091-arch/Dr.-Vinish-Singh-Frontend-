...
const conditionDetails = {
  ...
  subTitle: "TVT/TOT Sling Procedures & Pelvic Reconstruction",
  description: "Advanced minimally invasive sling surgeries (TVT/TOT) and pelvic floor biofeedback for urinary leakage in women by Senior Urologist Dr. Vinish Kumar Singh.",
  treatments: [
    {
      title: "Minimally Invasive Sling Surgery (TVT / TOT)",
      subtitle: "Gold Standard SUI Treatment",
      desc: "Sub-urethral synthetic mesh tape placement to support the urethral neck and prevent leakage during coughing, sneezing, or exercising.",
      highlights: ["Painless Keyhole Entry", "Daycare / 24h Discharge", "Immediate Leakage Control"],
      tag: "Minimally Invasive",
      bgIcon: "bg-blue-50 text-[#103F7C]",
      borderAccent: "border-t-4 border-t-[#103F7C]",
    },
    {
      title: "Pelvic Biofeedback & Medical Care",
      subtitle: "Non-Surgical Muscle Strengthening",
      desc: "Targeted Kegel biofeedback, pelvic floor physiotherapy, and medical bladder relaxant therapy for urge incontinence.",
      highlights: ["Non-Invasive Therapy", "Customized Physiotherapy", "Bladder Retraining"],
      tag: "Non-Surgical",
  ...
  symptoms: [
    { title: "Leakage When Coughing or Laughing", desc: "Involuntary urine loss during physical exertion, sneezing, or laughing." },
    { title: "Sudden Uncontrollable Urge", desc: "Sudden intense desire to urinate followed by immediate leakage." },
    { title: "Frequent Bladder Emptying", desc: "Needing to pass urine more than 8 times during daytime." },
    { title: "Loss of Pelvic Support", desc: "Sensation of fullness or pressure in pelvic region." },
  ]
};
    ...
    <section className="bg-slate-50/70 min-h-screen font-sans">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 lg:py-16">
        <div className="text-center max-w-3xl mx-auto mb-12">
          <div className="inline-flex items-center gap-1.5 px-3.5 py-1 rounded-full bg-blue-100/70 text-[#103F7C] text-xs font-extrabold uppercase tracking-wider mb-3">
            ...
            <span>INCONTINENCE SOLUTIONS</span>
          </div>
          ...
          <p className="text-xs sm:text-sm text-slate-600 mt-2 font-normal leading-relaxed">
            Modern sling procedures and non-surgical therapy designed to restore dryness and confidence.
          </p>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10">
        <div className="bg-white rounded-3xl p-8 border border-slate-200 shadow-sm">
          <h3 className="text-xl font-bold text-slate-900 mb-4">Types &amp; Symptoms of Incontinence</h3>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 pb-16 pt-6">
        <div className="rounded-3xl bg-gradient-to-r from-[#103F7C] via-blue-900 to-[#103F7C] text-white p-8 sm:p-10 flex flex-col sm:flex-row items-center justify-between gap-6 shadow-xl">
          <div>
            <h3 className="text-xl sm:text-2xl font-extrabold">Experiencing Involuntary Urine Leakage?</h3>
            <p className="text-xs sm:text-sm text-blue-100 mt-1 font-normal">Schedule a confidential consultation with Dr. Vinish Kumar Singh for permanent leakage solutions.</p>
          </div>
          <NavLink
            to="/contact"
