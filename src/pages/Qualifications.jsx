          ...
          <div className="lg:col-span-7 grid sm:grid-cols-2 gap-5">
            {qualifications.map((item, index) => {
              ...
              return (
                <div
                  key={index}
                  className="bg-white rounded-2xl p-6 border border-slate-200/80 shadow-xs hover:shadow-lg transition-all duration-300 hover:-translate-y-1 flex flex-col justify-between"
                >
                  <div>
