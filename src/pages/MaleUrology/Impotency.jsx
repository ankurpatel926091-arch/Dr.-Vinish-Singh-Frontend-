...
const conditionDetails = {
  ...
  subTitle: "Penile Implants & Shockwave Therapy",
  description: "Advanced surgical solutions including penile prosthesis implantation and regenerative therapy for severe impotence by Senior Urologist Dr. Vinish Kumar Singh.",
  treatments: [
    {
      title: "Penile Implant Surgery",
      subtitle: "Permanent Solution for Impotence",
      desc: "Implantation of semi-rigid or 3-piece inflatable penile prosthesis providing natural erection control with 95%+ satisfaction rates.",
      highlights: ["Permanent Erection Control", "Natural Feeling & Orgasm", "High Patient Satisfaction"],
      tag: "Penile Prosthesis",
      bgIcon: "bg-blue-50 text-[#103F7C]",
      borderAccent: "border-t-4 border-t-[#103F7C]",
    },
    {
      title: "Low-Intensity Shockwave Therapy (Li-ESWT)",
      subtitle: "Vascular Regeneration Therapy",
      desc: "Non-invasive acoustic shockwave treatment to stimulate microvascular angiogenesis and improve penile blood flow naturally.",
      highlights: ["Non-Invasive Procedure", "No Medication Required", "Stimulates New Blood Vessels"],
      tag: "Regenerative Care",
      bgIcon: "bg-orange-50 text-orange-600",
      borderAccent: "border-t-4 border-t-orange-500",
    },
  ],
  symptoms: [
    { title: "Inability to Achieve Erection", desc: "Complete inability to gain erection suitable for penetration." },
    { title: "Unresponsive to Medications", desc: "Oral ED pills (PDE5 inhibitors) no longer effective." },
    { title: "Vascular ED / Diabetes Related", desc: "Erectile failure secondary to long-term diabetes or arterial disease." },
    { title: "Post-Prostatectomy Impotence", desc: "Erectile dysfunction following pelvic or radical prostate surgery." },
  ]
};
    ...
    <section className="bg-slate-50/70 min-h-screen font-sans">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 lg:py-16">
        <div className="text-center max-w-3xl mx-auto mb-12">
          <div className="inline-flex items-center gap-1.5 px-3.5 py-1 rounded-full bg-blue-100/70 text-[#103F7C] text-xs font-extrabold uppercase tracking-wider mb-3">
            ...
            <span>ADVANCED IMPOTENCY SOLUTIONS</span>
          </div>
          <h2 className="text-2xl sm:text-4xl font-extrabold text-slate-900 tracking-tight">
            Restoring Erection &amp; Confidence
          </h2>
          <p className="text-xs sm:text-sm text-slate-600 mt-2 font-normal leading-relaxed">
            Modern penile implant procedures and regenerative therapies for men with organic or treatment-resistant impotence.
          </p>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10">
        <div className="bg-white rounded-3xl p-8 border border-slate-200 shadow-sm">
          <h3 className="text-xl font-bold text-slate-900 mb-4">Indications for Advanced Therapy</h3>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 pb-16 pt-6">
        <div className="rounded-3xl bg-gradient-to-r from-[#103F7C] via-blue-900 to-[#103F7C] text-white p-8 sm:p-10 flex flex-col sm:flex-row items-center justify-between gap-6 shadow-xl">
          <div>
            <h3 className="text-xl sm:text-2xl font-extrabold">Looking for Permanent Impotency Treatment?</h3>
            <p className="text-xs sm:text-sm text-blue-100 mt-1 font-normal">Consult Dr. Vinish Kumar Singh for penile implant evaluation and modern therapy.</p>
          </div>
          <NavLink
            to="/contact"
