...
const conditionDetails = {
  ...
  subTitle: "Penile Plaque & Curvature Correction",
  description: "Non-surgical plaque dissolution therapies and precision reconstructive surgery for Peyronie's disease by Senior Urologist Dr. Vinish Kumar Singh.",
  treatments: [
    {
      title: "Plaque Injections & Medical Therapy",
      subtitle: "Early Stage Non-Surgical Care",
      desc: "Targeted intra-lesional collagenase/medication injections and oral antioxidants to soften fibrous plaque during active inflammatory phase.",
      highlights: ["Plaque Softening", "Pain Reduction", "Stops Progression"],
      tag: "Non-Surgical",
      bgIcon: "bg-blue-50 text-[#103F7C]",
      borderAccent: "border-t-4 border-t-[#103F7C]",
    },
    {
      title: "Penile Plication & Grafting Surgery",
      subtitle: "Reconstructive Surgical Repair",
      desc: "Advanced reconstructive procedures (Nesbit/plication or plaque excision & dermal grafting) to straighten penile shaft curvature.",
      highlights: ["Anatomical Correction", "Preserves Length", "Restores Sexual Function"],
  ...
  symptoms: [
    { title: "Penile Curvature or Bending", desc: "Significant upward, downward, or side curvature during erection." },
    { title: "Palpable Hard Plaque", desc: "Hard fibrous tissue felt under the skin of the penile shaft." },
    { title: "Painful Erections", desc: "Pain during erection, especially during the active initial phase." },
    { title: "Penile Shortening & ED", desc: "Loss of penile length or difficulty maintaining firm erection." },
  ]
};
    ...
    <section className="bg-slate-50/70 min-h-screen font-sans">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12 lg:py-16">
        <div className="text-center max-w-3xl mx-auto mb-12">
          <div className="inline-flex items-center gap-1.5 px-3.5 py-1 rounded-full bg-blue-100/70 text-[#103F7C] text-xs font-extrabold uppercase tracking-wider mb-3">
            ...
            <span>PENILE RECONSTRUCTION</span>
          </div>
          <h2 className="text-2xl sm:text-4xl font-extrabold text-slate-900 tracking-tight">
            Comprehensive Peyronie's Care
          </h2>
          <p className="text-xs sm:text-sm text-slate-600 mt-2 font-normal leading-relaxed">
            Restoring natural anatomical alignment and sexual confidence through proven surgical and medical solutions.
          </p>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-10">
        <div className="bg-white rounded-3xl p-8 border border-slate-200 shadow-sm">
          <h3 className="text-xl font-bold text-slate-900 mb-4">Recognizing Symptoms</h3>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 pb-16 pt-6">
        <div className="rounded-3xl bg-gradient-to-r from-[#103F7C] via-blue-900 to-[#103F7C] text-white p-8 sm:p-10 flex flex-col sm:flex-row items-center justify-between gap-6 shadow-xl">
          <div>
            <h3 className="text-xl sm:text-2xl font-extrabold">Seeking Solution for Penile Curvature?</h3>
            <p className="text-xs sm:text-sm text-blue-100 mt-1 font-normal">Confidential evaluation and advanced treatment by Dr. Vinish Kumar Singh.</p>
          </div>
          <NavLink
            to="/contact"
